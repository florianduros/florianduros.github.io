...
export function Header() {
  return (
    <div className="desktop:px-10 desktop:pt-10 desktop:pb-5 desktop:w-header mobile:p-3 relative bg-zinc-700 print:bg-white text-white print:text-black rounded-t-lg flex items-center">
      <Photo />
      <div className="ml-5">
